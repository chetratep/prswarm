...
# (apps/api/node_modules/@bulk-github-update-tool/shared-types ->
...
RUN bun run --filter '@bulk-github-update-tool/shared-types' typecheck \
 && bun run --filter '@bulk-github-update-tool/api' typecheck \
 && bun run --filter '@bulk-github-update-tool/web' build
